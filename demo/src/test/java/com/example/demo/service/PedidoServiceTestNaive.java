...
// Ensure the correct package path for PedidoRequestDTO
import com.example.demo.DTO.PedidoRequestDTO; // Corrected package path.PedidoRequestDTO; // Corrected package path
...
public class PedidoServiceTestNaive {
  ...
  public void testConfirmarPedidoDesdeDTO() {
    ...
    Producto producto = productoRepository.save(
      new Producto("Pizza", 25000f, "Mediana", "imagen.jpg")
    );
    Adicional adicional = adicionalRepository.save(
      new Adicional("Queso extra", 3000f, "Extra de queso")
    );
  ...
  public void testListarPedidosPorCliente() {
    ...
    List<Pedido> pedidos = pedidoService.listarPedidosPorCliente(
      cliente.getId()
    );
  ...
  public void testAsignarDomiciliario() {
    ...
    Domiciliario domiciliario = domiciliarioRepository.save(
      new Domiciliario(null, "Luis", "3123456789", "123456789", true)
    );
