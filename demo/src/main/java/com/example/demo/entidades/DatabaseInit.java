...
public class DatabaseInit implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
            ...
            productoRepository.save(new Producto("Empanadas", 12.00f, "nuestras empanadas rellenas de carne, pollo o queso te ofrecen un sabor auténtico en cada bocado.", "/images/entrada3.png"));
            productoRepository.save(new Producto("Chorizada", 18.00f, "Sabroso chorizo artesanal con el toque justo de especias.", "/images/entrada4.png"));
